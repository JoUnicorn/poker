...
var Post = function Post(props) {
  ...
  }, props.show.dataset_data.start_date));
};
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return __WEBPACK_IMPORTED_MODULE_3_isomorphic_unfetch___default()("https://www.quandl.com/api/v3/datasets/WIKI/FB/data.json?api_key=MS2Rg8PPdkKdQix6s2dY");
          ...
          case 6:
            show = _context.sent;
            console.log(show);
            console.log("Fetched show: ".concat(show.dataset_data.frequency));
...
//# sourceMappingURL=6.6cac6fbe9da219d673c0.hot-update.js.map